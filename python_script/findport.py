# 1. Create a Python script that creates an empty list named ports. 
# Read the paragraph above, extract all the port numbers, and append them to the ports list. 
# Finally, print the ports list.
